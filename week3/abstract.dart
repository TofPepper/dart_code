...
//concrete class Square extend shape
class Square extends Shape {
  ...
  //Overide the abstract method to provide specific implementation
  @override
  double calculateArea() {
...
void main() {
  ...
  square.printInfo(); //Calls the concrete method in the abstract class
